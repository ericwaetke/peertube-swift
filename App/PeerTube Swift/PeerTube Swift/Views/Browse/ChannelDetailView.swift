...
struct ChannelDetailView: View {
    ...
    @ViewBuilder
    private func channelDetailContent(_ channel: Channel) -> some View {
        ScrollView {
    ...
    @ViewBuilder
    private func channelActionsSection(_ channel: Channel) -> some View {
        VStack(spacing: 12) {
            // Stats
            HStack(spacing: 20) {
                VStack {
    ...
    @ViewBuilder
    private func channelDescriptionSection(_ channel: Channel) -> some View {
