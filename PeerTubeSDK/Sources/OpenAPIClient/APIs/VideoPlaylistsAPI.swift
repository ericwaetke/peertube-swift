...
open class VideoPlaylistsAPI {
    ...
    open class func addPlaylistWithRequestBuilder(displayName: String, thumbnailfile: URL? = nil, privacy: VideoPlaylistPrivacySet? = nil, description: String? = nil, videoChannelId: Int? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<AddPlaylist200Response> {
        ...
        let localVariableFormParams: [String: (any Sendable)?] = [
            "displayName": displayName.asParameter(codableHelper: apiConfiguration.codableHelper),
            ...
            "videoChannelId": videoChannelId?.asParameter(codableHelper: apiConfiguration.codableHelper),
        ]
    ...
    open class func apiV1UsersMeVideoPlaylistsVideosExistGetWithRequestBuilder(videoIds: [Int], apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<ApiV1UsersMeVideoPlaylistsVideosExistGet200Response> {
        ...
        var localVariableUrlComponents = URLComponents(string: localVariableURLString)
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "videoIds": (wrappedValue: videoIds.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
        ])
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func reorderVideoPlaylist(playlistId: Int, reorderVideoPlaylistsOfChannelRequest: ReorderVideoPlaylistsOfChannelRequest? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await reorderVideoPlaylistWithRequestBuilder(playlistId: playlistId, reorderVideoPlaylistsOfChannelRequest: reorderVideoPlaylistsOfChannelRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func reorderVideoPlaylistWithRequestBuilder(playlistId: Int, reorderVideoPlaylistsOfChannelRequest: ReorderVideoPlaylistsOfChannelRequest? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<Void> {
