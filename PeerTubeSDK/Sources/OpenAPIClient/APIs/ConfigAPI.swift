...
open class ConfigAPI {
    ...
    /**
     * enum for parameter logoType
     */
    public enum LogoType_apiV1ConfigInstanceLogoLogoTypeDelete: String, Sendable, CaseIterable {
        case favicon = "favicon"
        case headerWide = "header-wide"
        case headerSquare = "header-square"
    ...
    /**
     ...
     - parameter logoType: (path)  
     - parameter apiConfiguration: The configuration for the http request.
     - returns: Void
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1ConfigInstanceLogoLogoTypeDelete(logoType: LogoType_apiV1ConfigInstanceLogoLogoTypeDelete, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await apiV1ConfigInstanceLogoLogoTypeDeleteWithRequestBuilder(logoType: logoType, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func apiV1ConfigInstanceLogoLogoTypeDeleteWithRequestBuilder(logoType: LogoType_apiV1ConfigInstanceLogoLogoTypeDelete, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<Void> {
        var localVariablePath = "/api/v1/config/instance-logo/:logoType"
        let logoTypePreEscape = "\(logoType.rawValue)"
        let logoTypePostEscape = logoTypePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{logoType}", with: logoTypePostEscape, options: .literal, range: nil)
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
     ...
     * enum for parameter logoType
     */
    public enum LogoType_apiV1ConfigInstanceLogoLogoTypePickPost: String, Sendable, CaseIterable {
        case favicon = "favicon"
        case headerWide = "header-wide"
        case headerSquare = "header-square"
        case opengraph = "opengraph"
    ...
    /**
     ...
     - parameter logoType: (path)  
     - parameter logofile: (form) The file to upload. (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: Void
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1ConfigInstanceLogoLogoTypePickPost(logoType: LogoType_apiV1ConfigInstanceLogoLogoTypePickPost, logofile: URL? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await apiV1ConfigInstanceLogoLogoTypePickPostWithRequestBuilder(logoType: logoType, logofile: logofile, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func apiV1ConfigInstanceLogoLogoTypePickPostWithRequestBuilder(logoType: LogoType_apiV1ConfigInstanceLogoLogoTypePickPost, logofile: URL? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<Void> {
        var localVariablePath = "/api/v1/config/instance-logo/:logoType/pick"
        let logoTypePreEscape = "\(logoType.rawValue)"
        let logoTypePostEscape = logoTypePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{logoType}", with: logoTypePostEscape, options: .literal, range: nil)
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableFormParams: [String: (any Sendable)?] = [
            "logofile": logofile?.asParameter(codableHelper: apiConfiguration.codableHelper),
        ]
