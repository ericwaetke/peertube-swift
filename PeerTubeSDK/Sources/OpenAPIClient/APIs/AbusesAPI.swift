...
open class AbusesAPI {
    ...
    open class func getAbusesWithRequestBuilder(id: Int? = nil, predefinedReason: [PredefinedReason_getAbuses]? = nil, search: String? = nil, state: AbuseStateSet? = nil, searchReporter: String? = nil, searchReportee: String? = nil, searchVideo: String? = nil, searchVideoChannel: String? = nil, videoIs: VideoIs_getAbuses? = nil, filter: Filter_getAbuses? = nil, start: Int? = nil, count: Int? = nil, sort: Sort_getAbuses? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<GetMyAbuses200Response> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "predefinedReason": (wrappedValue: predefinedReason?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
            ...
            "searchReporter": (wrappedValue: searchReporter?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
            "searchReportee": (wrappedValue: searchReportee?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
            "searchVideo": (wrappedValue: searchVideo?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
            "searchVideoChannel": (wrappedValue: searchVideoChannel?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
            "videoIs": (wrappedValue: videoIs?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
