...
open class VideoCommentsAPI {
    ...
    open class func apiV1UsersMeVideosCommentsGet(search: String? = nil, searchAccount: String? = nil, searchVideo: String? = nil, videoId: Int? = nil, videoChannelId: Int? = nil, autoTagOneOf: GetAccountVideosTagsAllOfParameter? = nil, isHeldForReview: Bool? = nil, includeCollaborations: Bool? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> ApiV1UsersMeVideosCommentsGet200Response {
        return try await apiV1UsersMeVideosCommentsGetWithRequestBuilder(search: search, searchAccount: searchAccount, searchVideo: searchVideo, videoId: videoId, videoChannelId: videoChannelId, autoTagOneOf: autoTagOneOf, isHeldForReview: isHeldForReview, includeCollaborations: includeCollaborations, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func apiV1UsersMeVideosCommentsGetWithRequestBuilder(search: String? = nil, searchAccount: String? = nil, searchVideo: String? = nil, videoId: Int? = nil, videoChannelId: Int? = nil, autoTagOneOf: GetAccountVideosTagsAllOfParameter? = nil, isHeldForReview: Bool? = nil, includeCollaborations: Bool? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<ApiV1UsersMeVideosCommentsGet200Response> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "searchAccount": (wrappedValue: searchAccount?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
            "searchVideo": (wrappedValue: searchVideo?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
            "videoId": (wrappedValue: videoId?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
            "videoChannelId": (wrappedValue: videoChannelId?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
            "autoTagOneOf": (wrappedValue: autoTagOneOf?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
            "isHeldForReview": (wrappedValue: isHeldForReview?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
    ...
    open class func apiV1VideosCommentsGetWithRequestBuilder(search: String? = nil, searchAccount: String? = nil, searchVideo: String? = nil, videoId: Int? = nil, videoChannelId: Int? = nil, autoTagOneOf: GetAccountVideosTagsAllOfParameter? = nil, isLocal: Bool? = nil, onLocalVideo: Bool? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<ApiV1UsersMeVideosCommentsGet200Response> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "onLocalVideo": (wrappedValue: onLocalVideo?.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
        ])
