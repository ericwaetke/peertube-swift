...
extension VideoService {
	...
	public func getRecentVideos(count: Int = 15) async throws -> VideoListResponse {
	...
	public func getPopularVideos(count: Int = 15) async throws -> VideoListResponse {
		let parameters = VideoListParameters(
			start: 0,
			count: count,
			sort: .views
	...
	public func getTrendingVideos(count: Int = 15) async throws -> VideoListResponse {
		let parameters = VideoListParameters(
			start: 0,
			count: count,
			sort: .likes
	...
	public func getLocalVideos(count: Int = 15) async throws -> VideoListResponse {
		let parameters = VideoListParameters(
			start: 0,
			count: count,
			sort: .createdAt,
	...
	public func getLiveVideos(count: Int = 15) async throws -> VideoListResponse {
		let parameters = VideoListParameters(
			start: 0,
			count: count,
			sort: .createdAt,
	...
	public func search(query: String, count: Int = 15) async throws -> VideoListResponse {
